...
class TestEnvironmentSecret(unittest.TestCase):
    """EnvironmentSecret unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentSecret:
        """Test EnvironmentSecret
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentSecret`
        """
    ...
    def testEnvironmentSecret(self):
        """Test EnvironmentSecret"""
