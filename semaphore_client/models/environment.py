...
class Environment(BaseModel):
    ...
    secrets: Optional[List[EnvironmentSecret]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "json": obj.get("json"),
            "env": obj.get("env"),
            "secrets": [EnvironmentSecret.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None
        })
        return _obj
