...
class ProjectBackupInventoriesInner(BaseModel):
    """
    ...
    become_key: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "inventory", "ssh_key", "become_key", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['static', 'static-yaml', 'file']):
            raise ValueError("must be one of enum values ('static', 'static-yaml', 'file')")
        return value
