...
class View(BaseModel):
    ...
    sort_reverse: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "title", "project_id", "position", "hidden", "type", "sort_column", "sort_reverse"]
    ...
    def sort_column_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['name']):
            raise ValueError("must be one of enum values ('name')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort_reverse": obj.get("sort_reverse")
        })
        return _obj
