...
class ProjectProjectIdTasksPostRequest(BaseModel):
    """
    ...
    inventory_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["template_id", "debug", "dry_run", "diff", "playbook", "environment", "limit", "git_branch", "message", "arguments", "inventory_id"]
