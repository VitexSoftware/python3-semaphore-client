...
class LoginMetadataOidcProvidersInner(BaseModel):
    """
    LoginMetadataOidcProvidersInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the provider, used in the login URL")
    name: Optional[StrictStr] = Field(default=None, description="Text to show on the login button")
