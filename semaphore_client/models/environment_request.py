...
class EnvironmentRequest(BaseModel):
    ...
    secrets: Optional[List[EnvironmentSecretRequest]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "project_id", "password", "json", "env", "secrets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "json": obj.get("json"),
            "env": obj.get("env"),
            "secrets": [EnvironmentSecretRequest.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None
        })
        return _obj
