...
class IntegrationRequest(BaseModel):
    ...
    params: Optional[TaskPrams] = None
    __properties: ClassVar[List[str]] = ["name", "project_id", "template_id", "params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": TaskPrams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
