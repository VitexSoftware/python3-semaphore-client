...
class InventoryRequest(BaseModel):
    ...
    ssh_key_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    become_key_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    repository_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "project_id", "inventory", "ssh_key_id", "become_key_id", "repository_id", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['static', 'static-yaml', 'file', 'terraform-workspace']):
            raise ValueError("must be one of enum values ('static', 'static-yaml', 'file', 'terraform-workspace')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "become_key_id": obj.get("become_key_id"),
