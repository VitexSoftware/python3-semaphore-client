...
class EnvironmentSecretRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "secret", "type", "operation"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['env', 'var']):
            raise ValueError("must be one of enum values ('env', 'var')")
        return value
